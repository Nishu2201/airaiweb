...
export const About3 = () => {
  return (
    <div className='bg-cover bg-center min-h-screen pt-12 child' style={{ backgroundImage: `url(${bg})` }}>
      <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 justify-items-center px-24 pb-6'>
        <div className='About3-content flex flex-col items-center justify-center text-white text-xl font-semibold text-center'>
