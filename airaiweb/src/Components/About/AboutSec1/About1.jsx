...
export const About1 = () => {
  return (
    <div className='AboutUs bg-cover bg-center min-h-screen overflow-hidden child' style={{ backgroundImage: `url(${bg})` }}>
      <Navbar />
...
Our goal is to provide participants with truly memorable experiences.</p>
        ...
        <div className='About1-pic flex items-center justify-center m-0 p-0 mb-6 ' >
          ...
          <div className="About-square">
            ...
            <span></span>
            <span></span>
            <img src={design} alt="Design" className='About1-img w-auto mt-7 ml-3 md:max-w-full md:h-auto relative z-10' />
          </div>
        </div>
      </div>
    </div>
