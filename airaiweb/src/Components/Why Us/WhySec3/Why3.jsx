...
const Why3 = () => {
  return (
    <div className='why3 bg-cover bg-center bg-no-repeat min-h-screen p-4 lg:pb-0 child' style={{backgroundImage:`url(${bg})`}}>
      <div className='flex items-center justify-center lg:p-12 px-12 pt-3'>
        <h1 className='why3-head text-white text-4xl font-black font-lato text-center'>Here's What You Get:</h1>
      </div>
