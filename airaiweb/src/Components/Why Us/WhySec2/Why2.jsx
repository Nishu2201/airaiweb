...
const Why2 = () => {
  return (
    <div className='bg-cover bg-center bg-no-repeat min-h-screen child' style={{ backgroundImage: `url(${bg})` }}>
      <div className='flex items-center justify-center p-8 md:p-16 pb-8 md:pb-12'>
        <h1 className='why2-head text-white text-4xl font-black font-lato text-center '>Why work with us?</h1>
      </div>
      <div className='Why2 flex flex-col md:flex-row justify-center items-center mx-4 md:mx-9'>
        ...
        <div className='Box1 flex flex-col items-center justify-center border-2 pb-5 m-4 md:m-9 mt-6 h-auto md:h-full w-full md:w-84 works ways'>
          ...
          <h1 className='text-white text-2xl font-bold font-barlow mb-2 text-center px-6 pt-3 h-24'>Experience and<br/> Expertise</h1>
