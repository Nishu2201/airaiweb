            ...
            <div className='navbar h-10vh pt-6 flex justify-between items-center z-50 text-white lg:py-5 pl-0 py-9  flex-1 pt-12 '>
                ...
                <div className='nav-items hidden lg:flex flex-2 items-center justify-center font-normal pr-28'>
                    <ul className='font-lato font-medium flex gap-2 mt-4 items-center justify-center z-40'>
                        <li>
                            <a href='/about' className='pr-4 text-[18px] font-bold z-40'>
                                About
                            </a>
                        </li>
                        <li>
                            <a href='/services' className='px-5 text-[18px] font-bold z-40'>
                                Services
                            </a>
                        </li>
                        <li>
                            <a href='/whyus' className='px-5 text-[18px] font-bold z-40'>
                                Why Us
                            </a>
                        </li>
                        <li>
                            <a href='/contact' className='px-5 text-[18px] font-bold z-40'>
                                Contact
                            </a>
                        </li>
                        <li>
