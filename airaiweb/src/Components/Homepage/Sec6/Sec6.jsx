...
const Sec6 = () => {
  return (
    <div className='Sec6-div bg-cover bg-center h-screen p-9 relative child ' style={{ backgroundImage: `url(${bg})` }}>
      ...
      <div className='steps-div2'>
        <img src={steps2} alt="" className='step-img2'/>
      </div>
      <div className='steps-div flex flex-col md:flex-row gap-4 relative'>
        <div className='flex-1 md:flex-shrink-0 md:w-1/4 p-6 flex flex-col items-center pt-1'>
          <div className='steps-content h-96 w-84'>
            <div className='Sprt pb-9 pr-9 pt-3'>
              <img src={suport} alt="" className='Sprt-pic p-6 pb-2 mx-auto' />
              <h1 className='text-white text-xl text-center font-bold pt-2'>Support & Maintenance</h1>
            </div>
            <div className='Dep p-16 pt-12 pl-3 pr-56'>
              <img src={launch} alt="" className='Dep-pic p-6 pb-2 mx-auto' />
              <h1 className='text-white text-xl text-center font-bold'>Deployment & Launch</h1>
            </div>
            <div className='Test pt-5  pr-10'>
              <img src={test} alt="" className='Text-pic p-4 pb-2 mx-auto' />
        ...
        <div className='flex-1 md:flex-shrink-0 md:w-1/4 p-6 pt-6 flex flex-col items-center'>
          <div className='steps-content2 h-96 w-84'>
            <div className='Scope pb-9 pr-12 pt-3'>
              <img src={scope} alt="" className='Scope-pic p-3 pl-6pb-2 mx-auto' />
              <h1 className='text-white text-xl text-center font-bold'>Scope Analysis</h1>
            </div>
            <div className='Plan pt-12  pb-20 pl-48'>
              <img src={plan} alt="" className='Plan-pic p-6 pb-2 mx-auto' />
              <h1 className='text-white text-xl text-center font-bold'>Discuss & Planning</h1>
            </div>
            <div className='Des pt-3 pl-12'>
              <img src={functions} alt="" className='Des-pic pt-0 pb-2 mx-auto' />
