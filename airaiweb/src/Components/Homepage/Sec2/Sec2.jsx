...
export const Sec2 = () => {
  return (
    <div  className='Sec2 bg-cover bg-center min-h-screen p-6 overflow-hidden child' style={{ backgroundImage: `url(${bg})` }}>
      ...
      <div className='about-pic flex items-center justify-center m-0 p-0 mb-6  ' >

<div className="square ">
  <span></span>
  <span></span>
  <span></span>
  <img src={design} alt="Design" className='about-design  mt-7 ml-3  relative z-10' />
</div>
</div>
